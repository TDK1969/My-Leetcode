...
scheduler.add_job(CheckContests, "cron", day_of_week=5, hour="20", id="LeetcodeContest", misfire_grace_time=90)
scheduler.add_job(InitialDaily, "cron", hour="0", id="LeetcodeInit" ,misfire_grace_time=90)
print("running leetcode bot.")
scheduler.start()