...
class Solution:
    def findRightInterval(self, intervals: List[List[int]]) -> List[int]:
        originIndex = {interval[0]: index for index, interval in enumerate(intervals)}
