...
class Solution:
    def countPaths(self, n: int, roads: List[List[int]]) -> int:
        ...
        for u, v, cost in roads:
            line[u].append((v, cost))
            line[v].append((u, cost))
        mod = 10**9 + 7
        count = 0
        visited = {0}
        min_time = float("inf")
